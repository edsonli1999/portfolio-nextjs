...
function ExperienceCard({ companyName, companyUrl, companyIcon, position, tenure, description, summaryNotes, techStack }: ExperienceCardProps) {
  ...
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-full lg:w-[400px] md:w-[600px] xl:w-[800px] lg:snap-center bg-[#292929] p-10 lg:hover:opacity-100 lg:opacity-40 opacity-100 transition-opacity duration-200 overflow-y-scroll z-10 scrollbar'>
      {companyUrl && (
      ...
      <div className='px-0 md:px-10'>
        ...
        <div className="flex space-x-2 my-2">
          {techStack.map((link, index) => (
            // Modified to use Next.js Image Component
