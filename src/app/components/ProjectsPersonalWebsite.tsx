    ...
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[800px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 transition-opacity duration-200 overflow-y-scroll'>
      ...
      <div className='px-0 md:px-10'>
        ...
        <p className='space-y-4 ml-5 text-md p-5'>
          A personal portfolio website, which showcases my experience and skills related to technology. It also serves to show more about myself, including hobbies, interests, and lifestyle. Front end uses NextJS, TypeScript, and Framer Motion. It is deployed on Vercel, with more technologies to be used in the future. For more details check out my github &#128578;.
        </p>
      </div>
    </article>
  )
